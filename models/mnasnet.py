...
class _InvertedResidual(nn.Module):
    ...
    def forward(self, input: Tensor) -> Tensor:
        if self.apply_residual:
            return self.skip_add.add(self.layers(input), input)
        else:
...
class QuantizableMNASNet(torch.nn.Module):
    """MNASNet, as described in https://arxiv.org/pdf/1807.11626.pdf. This
    implements the B1 variant of the model.
    >>> model = QuantizableMNASNet(1.0, num_classes=1000)
...
def mnasnet0_5(
    ...
    **kwargs: Any,
    ...
    return _mnasnet(0.5, weights, progress, quantize, is_qat, **kwargs)
...
def mnasnet0_75(
    ...
    **kwargs: Any,
    ...
    return _mnasnet(0.75, weights, progress, quantize, is_qat, **kwargs)
...
def mnasnet1_0(
    ...
    **kwargs: Any,
    ...
    return _mnasnet(1.0, weights, progress, quantize, is_qat, **kwargs)
...
def mnasnet1_3(
    ...
    **kwargs: Any,
    ...
    return _mnasnet(1.3, weights, progress, quantize, is_qat, **kwargs)
