...
class ResBottleneckBlock(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        if self.proj is not None:
            x = self.skip_add.add(self.proj(x), self.f(x))
        else:
            x = self.skip_add.add(x, self.f(x))
...
def regnet_y_400mf(
    ...
    **kwargs: Any,
    ...
    return _regnet(params, weights, progress, quantize, is_qat, **kwargs)


@handle_legacy_interface(weights=("pretrained", RegNet_Y_800MF_Weights.IMAGENET1K_V1))
def regnet_y_800mf(
    *,
    weights: Optional[RegNet_Y_800MF_Weights] = None,
    progress: bool = True,
    quantize: bool = False,
    is_qat: bool = False,
    **kwargs: Any,
...
def regnet_y_1_6gf(
    *,
    weights: Optional[RegNet_Y_1_6GF_Weights] = None,
    progress: bool = True,
    quantize: bool = False,
    is_qat: bool = False,
    **kwargs: Any,
...
def regnet_y_3_2gf(
    *,
    weights: Optional[RegNet_Y_3_2GF_Weights] = None,
    progress: bool = True,
    quantize: bool = False,
    is_qat: bool = False,
    **kwargs: Any,
...
def regnet_y_16gf(
    *,
    weights: Optional[RegNet_Y_16GF_Weights] = None,
    progress: bool = True,
    quantize: bool = False,
    is_qat: bool = False,
    **kwargs: Any,
...
def regnet_y_32gf(
    *,
    weights: Optional[RegNet_Y_32GF_Weights] = None,
    progress: bool = True,
    quantize: bool = False,
    is_qat: bool = False,
    **kwargs: Any,
...
def regnet_y_128gf(
    *,
    weights: Optional[RegNet_Y_128GF_Weights] = None,
    progress: bool = True,
    quantize: bool = False,
    is_qat: bool = False,
    **kwargs: Any,
...
def regnet_x_400mf(
    *,
    weights: Optional[RegNet_X_400MF_Weights] = None,
    progress: bool = True,
    quantize: bool = False,
    is_qat: bool = False,
    **kwargs: Any,
...
def regnet_x_800mf(
    *,
    weights: Optional[RegNet_X_800MF_Weights] = None,
    progress: bool = True,
    quantize: bool = False,
    is_qat: bool = False,
    **kwargs: Any,
...
def regnet_x_1_6gf(
    *,
    weights: Optional[RegNet_X_1_6GF_Weights] = None,
    progress: bool = True,
    quantize: bool = False,
    is_qat: bool = False,
    **kwargs: Any,
...
def regnet_x_3_2gf(
    *,
    weights: Optional[RegNet_X_3_2GF_Weights] = None,
    progress: bool = True,
    quantize: bool = False,
    is_qat: bool = False,
    **kwargs: Any,
...
def regnet_x_8gf(
    *,
    weights: Optional[RegNet_X_8GF_Weights] = None,
    progress: bool = True,
    quantize: bool = False,
    is_qat: bool = False,
    **kwargs: Any,
...
def regnet_x_16gf(
    *,
    weights: Optional[RegNet_X_16GF_Weights] = None,
    progress: bool = True,
    quantize: bool = False,
    is_qat: bool = False,
    **kwargs: Any,
...
def regnet_x_32gf(
    *,
    weights: Optional[RegNet_X_32GF_Weights] = None,
    progress: bool = True,
    quantize: bool = False,
    is_qat: bool = False,
    **kwargs: Any,
...
def fuse_regnet(model: nn.Module, is_qat: bool = False) -> None:
    for module_name, module in model.named_children():
        if module_name == "stem":
            _fuse_modules(
                module, modules_to_fuse=[["0", "1", "2"]], is_qat=is_qat, inplace=True
            )
            ...
            fuse_regnet(module, is_qat=is_qat)
...
if __name__ == "__main__":
    models = [
        ...
        regnet_x_400mf(quantize=True, is_qat=False),
